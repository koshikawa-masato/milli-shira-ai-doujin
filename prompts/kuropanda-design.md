...
**Oracle（正面・絶対の基準、2026-08-22）**: `compare/kuropanda_v2/20260822-162704-170_0.png`（v2 step 800、seed 0、短文プロンプト）。詳細は `kuropanda-character.md`
旧基準（v2 素材の元）: `circlecut/20260821-194041-801_0.png`（サークルカット採用、斜め向き）
